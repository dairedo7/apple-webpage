...
const GsapText = () => {
  ...
  useGSAP(() => {
    ...
    gsap.fromTo('.para', { opacity: 0, y: 20 }, { opacity: 1, y: 0, delay: 1, stagger: 0.2 });
  }, []);
  ...
  return (
    <main>
      ...
      <p className="mt-5 text-gray-500 para">
        We can use same method like <code>gsap.to()</code>, <code>gsap.from()</code>, <code>gsap.fromTo()</code> and <code>gsap.timeline()</code> to animate
        text.
      </p>
